        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900 dark:text-gray-100">
                    ...
                    <!-- Success Message -->
                    <div id="success-message" class="mb-3 p-3 bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 rounded-lg hidden">
                        <strong class="font-bold">Success!</strong> <span id="success-text"></span>
                    </div>

                    <!-- Error Message -->
                    <div id="error-message" class="mb-3 p-3 bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300 rounded-lg hidden">
                        <strong class="font-bold">Error!</strong> <span id="error-text"></span>
                    </div>

                    <form id="event-form" enctype="multipart/form-data" class="space-y-4">
                        @csrf
